const tableEn: { [key: string]: string } = {
    ...
    "repositories.typizator-handler.about": "Well-typed API handlers for AWS Lambdas with database integration. CDK stack integration for well-typed Typescript libraries.",
    ...
    "repositories.tgbot.lib": "Bot implemented using the typizator-handler library",
    "lang.ZH-CN": "Chinese",
    "lang.UK": "Ukrainian",
    "lang.ES": "Spanish",
    "lang.AR": "Arabic",
...
const tableFr: { [key: string]: string } = {
    ...
    "repositories.typizator-handler.about": "Gestionnaires API bien typés pour des Lambdas AWS avec l'intégration des bases des données. Intégration du stack CDK pour les bibliothèques Typescript bien typées.",
    ...
    "repositories.tgbot.lib": "Bot implémenté avec la bibliothèque typizator-handler",
    "lang.ZH-CN": "Chinois",
    "lang.UK": "Ukrainien",
    "lang.ES": "Espagnol",
    "lang.AR": "Arabe",
    ...
    "Contract address on": "Adresse du contrat sur",
    "Switch to": "Passer vers",
    "Connected": "Connecté",
    "Waiting...": "En attente...",
...
const tableRu: { [key: string]: string } = {
    ...
    "repositories.typizator-handler.about": "Типизированные обработчики API для AWS Lambdas с интеграцией баз данных. Интеграция стека CDK для типизированных библиотекTypescript",
    ...
    "repositories.tgbot.lib": "Бот, реализованный через библиотеку typizator-handler",
    ...
    "D/W TON contract": "Контракт TON В/В",
    ...
    "React hook libs": "Библиотеки хуков React",
    "Transactions list": "Список транзакций",
    "Contract address on": "Адрес контракта на",
