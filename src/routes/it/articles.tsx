...
const MediumArticle = ({ url, img, title }: { url: string, img: string, title: string }) => {
...
export const Route = createFileRoute('/it/articles')({
    component: () => <div className='flex flex-row flex-wrap flex-grow-1 overflow-y-visible bg-white min-w-0 min-h-0'>
        <MediumArticle
