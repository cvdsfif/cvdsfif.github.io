...
describe("Testing the publications page", () => {
    const routeSetup = setupTestedRoute("../../src/routes/it/articles.lazy")
    ...
    test("Should load the translated page", () => {
        ...
        expect(getByTestId(container, "title")).toHaveTextContent("Публикации")
    })
    ...
    test("Should follow link on click", async () => {
        ...
        await getByTestId(container, "link1").click()
